...
public class PhoneUtils {
	...
	//营运商MNC值
	public static final String OPERATOR_CM_MNC = BundleUtils.getStringValue(Constants.PROPERTIES_KEY_CORE_FILE, "imsi.mnc.cb");	//中国移动
	public static final String OPERATOR_CU_MNC = BundleUtils.getStringValue(Constants.PROPERTIES_KEY_CORE_FILE, "imsi.mnc.cu");		//中国联通
	public static final String OPERATOR_CTE_MNC  = BundleUtils.getStringValue(Constants.PROPERTIES_KEY_CORE_FILE, "imsi.mnc.cte");;//中国电信
	public static final String OPERATOR_CTI_MNC  = BundleUtils.getStringValue(Constants.PROPERTIES_KEY_CORE_FILE, "imsi.mnc.cti");	//中国铁通
